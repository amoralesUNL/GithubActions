[![Run App][![Run App FullName](https://github.com/amoralesUNL/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/amoralesUNL/GithubActions/actions/workflows/run-app.yaml))
